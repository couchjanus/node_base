...
exports.update_password_post = (req, res, next) => {
  req.assert('password', 'Password must be at least 4 characters long').len(4);
  req.assert('confirmPassword', 'Passwords do not match').equals(req.body.password);
...
exports.delete_account_post = (req, res, next) => {
...
exports.oauth_unlink_get = (req, res, next) => {
...
exports.reset_get = (req, res, next) => {
...
exports.roleAuthorization = (roles) => {
    return (req, res, next) => {
      ...
      User.findById(user._id, (err, foundUser) => {
        ...
        req.flash('errors', { msg: 'You are not authorized to view this content' });
